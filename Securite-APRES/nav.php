...
<div style="text-align:center;position:fixed;right:0;bottom:0;background-color:white;opacity:0.5;border:1px solid grey;">
<?php
echo "<strong>" . session_name() . "</strong>" . "<br>";
echo session_id();
echo "</div>";
